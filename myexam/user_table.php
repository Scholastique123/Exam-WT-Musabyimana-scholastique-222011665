...
<head>
    ...
    <title>Videography platform</title>
    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        <h2 style="text-align: center; font-family: century; font-weight: bold;">VIDEOGRAPHY SERVICE</h2>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 $stmt = $conn->prepare("INSERT INTO user (uid, first_name, last_name, tin_number, address, email, registration_date, agent_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
